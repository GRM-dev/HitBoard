...
public class FileOperation {
	...
	public static Logger setupLogger(String fileName) throws IllegalArgumentException {
		...
		try {
			String logFilename = Config.EXECUTABLE_PATH + fileName;
		...
		logger.info("Execution Location: " + Config.EXECUTABLE_PATH);
		return logger;
	}
	...
	public static File getFile(String fileName) throws FileNotFoundException {
		...
		if (file == null
				|| !file.exists()) { throw new FileNotFoundException("Nie znaleziono pliku o nazwie " + fileName); }
		return file;
	}
}
